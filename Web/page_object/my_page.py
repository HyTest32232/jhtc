...
from Web.page_object.organization_manage_page import OrganizationPage
...
class MyPage(BasePage):
    ...
    def go_to_organzation_manage(self):
        self.find(By.CSS_SELECTOR,'#app > div > div:nth-child(2) > div > div.left > div > div.barlist > div:nth-child(1)').click()
